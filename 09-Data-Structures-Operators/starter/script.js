...
// // example 01
// let introduction = ['Hello', 'I', 'am', 'Yanka'];
// // let greeting = introduction[0];
// // let name = introduction[3];

// // console.log(greeting); //"Hello"
// // console.log(name); //"Yanka"

// // now using destruturing
...
// 1.
// aqui pega um set e transforma em array
const events = [...new Set(gameEvents.values())];
console.log(events);

// aqui é apenas um set
const eve = new Set(gameEvents.values());
console.log(eve);
